                ...
                children: [
                  ...
                  ClipRRect(
                    ...
                    child: Column(
                      children:  [
                        AccountSetting(
                          name: 'View Account', onTap: () { 
                            context.pushNamed(viewAccount);
                           },
                        ),
                        Divider(
                          thickness: 1,
                        ...
                        AccountSetting(name: 'Pin Managment', onTap: () { 
                            context.pushNamed(pinManagement);
                         },),
                      ],
                    ),
                  ),
...
class AccountSetting extends StatelessWidget {
  ...
  const AccountSetting({super.key, required this.name,required this.onTap});
